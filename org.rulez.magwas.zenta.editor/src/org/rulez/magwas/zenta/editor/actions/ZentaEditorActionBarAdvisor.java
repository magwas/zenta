 ...
 */
public class ZentaEditorActionBarAdvisor
extends ActionBarAdvisor {
    
    private IWorkbenchAction fActionNewZentaModel;
     ...
     * @param configurer
     */
    public ZentaEditorActionBarAdvisor(IActionBarConfigurer configurer) {
        super(configurer);
    }
    ...
    protected void makeActions(final IWorkbenchWindow window) {
        ...
        // New Zenta model
        fActionNewZentaModel = new NewZentaModelAction();
        register(fActionNewZentaModel);
        
        // Open Diagram
        fActionOpenDiagram = ZentaEditorActionFactory.OPEN_DIAGRAM.create(window);
        register(fActionOpenDiagram);
        
        // Close Model
        fActionCloseModel = ZentaEditorActionFactory.CLOSE_MODEL.create(window);
        register(fActionCloseModel);
        
        // Close Editor
        fActionCloseEditor = ActionFactory.CLOSE.create(window);
        fActionCloseEditor.setText(Messages.ZentaEditorActionBarAdvisor_0);
        register(fActionCloseEditor);

        // Close All Editors
        fActionCloseAllEditors = ActionFactory.CLOSE_ALL.create(window);
        fActionCloseAllEditors.setText(Messages.ZentaEditorActionBarAdvisor_1);
        register(fActionCloseAllEditors);
        
        // Save
        fActionSave = ZentaEditorActionFactory.SAVE_MODEL.create(window);
        register(fActionSave);
        
        // Save As
        fActionSaveAs = ZentaEditorActionFactory.SAVE_AS.create(window);
        ...
        // Delete
        fActionDelete = ZentaEditorActionFactory.DELETE.create(window);
        register(fActionDelete);
        
        // Rename
        fActionRename = ZentaEditorActionFactory.RENAME.create(window);
        register(fActionRename);
        
        // Duplicate
        fActionDuplicate = ZentaEditorActionFactory.DUPLICATE.create(window);
        ...
        fActionResetPerspective.setText(Messages.ZentaEditorActionBarAdvisor_2);
        ...
        fShowPaletteView = new ToggleViewAction(Messages.ZentaEditorActionBarAdvisor_6, PaletteView.ID,
            ...
            public String getToolTipText() {
                return Messages.ZentaEditorActionBarAdvisor_7;
            };
        };
    ...
    private MenuManager createFileMenu() {
        ...
        MenuManager menu = new MenuManager(Messages.ZentaEditorActionBarAdvisor_8, IWorkbenchActionConstants.M_FILE);
        menu.add(new GroupMarker(IWorkbenchActionConstants.FILE_START));

        // New
        MenuManager newMenu = new MenuManager(Messages.ZentaEditorActionBarAdvisor_9, "new_menu"); //$NON-NLS-1$
        menu.add(newMenu);
        newMenu.add(fActionNewZentaModel);
        ...
        MenuManager importMenu = new MenuManager(Messages.ZentaEditorActionBarAdvisor_10, "import_menu"); //$NON-NLS-1$
        menu.add(importMenu);
        ...
        MenuManager exportMenu = new MenuManager(Messages.ZentaEditorActionBarAdvisor_11, "export_menu"); //$NON-NLS-1$
        menu.add(exportMenu);
        ...
        MenuManager reportMenu = new MenuManager(Messages.ZentaEditorActionBarAdvisor_12, "report_menu"); //$NON-NLS-1$
        menu.add(reportMenu);
    ...
    private MenuManager createEditMenu() {
        ...
        MenuManager menu = new MenuManager(Messages.ZentaEditorActionBarAdvisor_13, IWorkbenchActionConstants.M_EDIT);
    ...
    private MenuManager createWindowMenu() {
        ...
        MenuManager menu = new MenuManager(Messages.ZentaEditorActionBarAdvisor_14, IWorkbenchActionConstants.M_WINDOW);
        ...
        MenuManager navigationMenu = new MenuManager(Messages.ZentaEditorActionBarAdvisor_15);
    ...
    private MenuManager createHelpMenu() {
        ...
        MenuManager menu = new MenuManager(Messages.ZentaEditorActionBarAdvisor_16, IWorkbenchActionConstants.M_HELP);
