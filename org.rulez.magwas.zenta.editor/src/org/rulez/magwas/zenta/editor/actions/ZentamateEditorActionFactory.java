 ...
 */
public final class ZentamateEditorActionFactory {
    ...
    public static final ActionFactory DELETE = new ActionFactory("delete", //$NON-NLS-1$
        ...
        public IWorkbenchAction create(IWorkbenchWindow window) {
            ...
            LabelRetargetAction action = new LabelRetargetAction(getId(), Messages.ZentamateEditorActionFactory_0);
            action.setToolTipText(Messages.ZentamateEditorActionFactory_1);
    ...
    public static final ActionFactory RENAME = new ActionFactory("rename", //$NON-NLS-1$
        ...
        public IWorkbenchAction create(IWorkbenchWindow window) {
            ...
            LabelRetargetAction action = new LabelRetargetAction(getId(), Messages.ZentamateEditorActionFactory_2);
            action.setToolTipText(Messages.ZentamateEditorActionFactory_3);
            window.getPartService().addPartListener(action);
            action.setActionDefinitionId(getCommandId());
            return action;
        }
    ...
    public static final ActionFactory OPEN_DIAGRAM = new ActionFactory("open_diagram", //$NON-NLS-1$
                                    "org.rulez.magwas.zenta.editor.action.openDiagram") { //$NON-NLS-1$
        ...
        public IWorkbenchAction create(IWorkbenchWindow window) {
            ...
            RetargetAction action = new RetargetAction(getId(), Messages.ZentamateEditorActionFactory_4);
            window.getPartService().addPartListener(action);
    ...
    public static final ActionFactory CLOSE_MODEL = new ActionFactory("close_model", //$NON-NLS-1$
                                    "org.rulez.magwas.zenta.editor.action.closeModel") { //$NON-NLS-1$
        ...
        public IWorkbenchAction create(IWorkbenchWindow window) {
            ...
            RetargetAction action = new RetargetAction(getId(), Messages.ZentamateEditorActionFactory_5);
            window.getPartService().addPartListener(action);
            // Don't do this unless registering a key binding in plugin.xml
            action.setActionDefinitionId(getCommandId());
            return action;
    ...
    public static final ActionFactory DUPLICATE = new ActionFactory("duplicate", //$NON-NLS-1$
                                "org.rulez.magwas.zenta.editor.action.duplicate") { //$NON-NLS-1$
        ...
        public IWorkbenchAction create(IWorkbenchWindow window) {
            ...
            LabelRetargetAction action = new LabelRetargetAction(getId(), Messages.ZentamateEditorActionFactory_6);
            window.getPartService().addPartListener(action);
            // Don't do this unless registering a key binding in plugin.xml
            action.setActionDefinitionId(getCommandId());
            return action;
