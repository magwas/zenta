 ...
 */
public class ZentamateEditorActionBarAdvisor
extends ActionBarAdvisor {
    
    private IWorkbenchAction fActionNewZentamateModel;
     ...
     * @param configurer
     */
    public ZentamateEditorActionBarAdvisor(IActionBarConfigurer configurer) {
        super(configurer);
    }
    ...
    protected void makeActions(final IWorkbenchWindow window) {
        ...
        // New Zentamate model
        fActionNewZentamateModel = new NewZentamateModelAction();
        register(fActionNewZentamateModel);
        
        // Open Diagram
        fActionOpenDiagram = ZentamateEditorActionFactory.OPEN_DIAGRAM.create(window);
        register(fActionOpenDiagram);
        
        // Close Model
        fActionCloseModel = ZentamateEditorActionFactory.CLOSE_MODEL.create(window);
        register(fActionCloseModel);
        
        // Close Editor
        fActionCloseEditor = ActionFactory.CLOSE.create(window);
        fActionCloseEditor.setText(Messages.ZentamateEditorActionBarAdvisor_0);
        register(fActionCloseEditor);

        // Close All Editors
        fActionCloseAllEditors = ActionFactory.CLOSE_ALL.create(window);
        fActionCloseAllEditors.setText(Messages.ZentamateEditorActionBarAdvisor_1);
        register(fActionCloseAllEditors);
        
        // Save
        fActionSave = ZentamateEditorActionFactory.SAVE_MODEL.create(window);
        register(fActionSave);
        
        // Save As
        fActionSaveAs = ZentamateEditorActionFactory.SAVE_AS.create(window);
        ...
        // Delete
        fActionDelete = ZentamateEditorActionFactory.DELETE.create(window);
        register(fActionDelete);
        
        // Rename
        fActionRename = ZentamateEditorActionFactory.RENAME.create(window);
        register(fActionRename);
        
        // Duplicate
        fActionDuplicate = ZentamateEditorActionFactory.DUPLICATE.create(window);
        ...
        fActionResetPerspective.setText(Messages.ZentamateEditorActionBarAdvisor_2);
        ...
        fShowModelsView = new ToggleViewAction(ITreeModelView.NAME, ITreeModelView.ID,
                "org.rulez.magwas.zenta.editor.action.showTreeModelView", ITreeModelView.IMAGE_DESCRIPTOR); //$NON-NLS-1$
        register(fShowModelsView);
        
        fShowPropertiesView = new ToggleViewAction(Messages.ZentamateEditorActionBarAdvisor_3, ViewManager.PROPERTIES_VIEW,
                "org.rulez.magwas.zenta.editor.action.showPropertiesView", IZentamateImages.ImageFactory.getImageDescriptor(IZentamateImages.ECLIPSE_IMAGE_PROPERTIES_VIEW_ICON)); //$NON-NLS-1$
        register(fShowPropertiesView);
        
        fShowOutlineView = new ToggleViewAction(Messages.ZentamateEditorActionBarAdvisor_4, ViewManager.OUTLINE_VIEW,
                "org.rulez.magwas.zenta.editor.action.showOutlineView", IZentamateImages.ImageFactory.getImageDescriptor(IZentamateImages.ECLIPSE_IMAGE_OUTLINE_VIEW_ICON)); //$NON-NLS-1$
        register(fShowOutlineView);
        
        fShowNavigatorView = new ToggleViewAction(Messages.ZentamateEditorActionBarAdvisor_5, INavigatorView.ID,
                "org.rulez.magwas.zenta.editor.action.showNavigatorView", INavigatorView.IMAGE_DESCRIPTOR); //$NON-NLS-1$
        register(fShowNavigatorView);

        fShowPaletteView = new ToggleViewAction(Messages.ZentamateEditorActionBarAdvisor_6, PaletteView.ID,
                                    "org.rulez.magwas.zenta.editor.action.showPaletteView", //$NON-NLS-1$
                                    AbstractUIPlugin.imageDescriptorFromPlugin("org.eclipse.gef", //$NON-NLS-1$
                                    "$nl$/icons/palette_view.gif")) { //$NON-NLS-1$
            @Override
            public String getToolTipText() {
                return Messages.ZentamateEditorActionBarAdvisor_7;
            };
        };
    ...
    private MenuManager createFileMenu() {
        ...
        MenuManager menu = new MenuManager(Messages.ZentamateEditorActionBarAdvisor_8, IWorkbenchActionConstants.M_FILE);
        menu.add(new GroupMarker(IWorkbenchActionConstants.FILE_START));

        // New
        MenuManager newMenu = new MenuManager(Messages.ZentamateEditorActionBarAdvisor_9, "new_menu"); //$NON-NLS-1$
        menu.add(newMenu);
        newMenu.add(fActionNewZentamateModel);
        ...
        MenuManager importMenu = new MenuManager(Messages.ZentamateEditorActionBarAdvisor_10, "import_menu"); //$NON-NLS-1$
        menu.add(importMenu);
        ...
        MenuManager exportMenu = new MenuManager(Messages.ZentamateEditorActionBarAdvisor_11, "export_menu"); //$NON-NLS-1$
        menu.add(exportMenu);
        ...
        MenuManager reportMenu = new MenuManager(Messages.ZentamateEditorActionBarAdvisor_12, "report_menu"); //$NON-NLS-1$
        menu.add(reportMenu);
    ...
    private MenuManager createEditMenu() {
        ...
        MenuManager menu = new MenuManager(Messages.ZentamateEditorActionBarAdvisor_13, IWorkbenchActionConstants.M_EDIT);
    ...
    private MenuManager createWindowMenu() {
        ...
        MenuManager menu = new MenuManager(Messages.ZentamateEditorActionBarAdvisor_14, IWorkbenchActionConstants.M_WINDOW);
        ...
        MenuManager navigationMenu = new MenuManager(Messages.ZentamateEditorActionBarAdvisor_15);
    ...
    private MenuManager createHelpMenu() {
        ...
        MenuManager menu = new MenuManager(Messages.ZentamateEditorActionBarAdvisor_16, IWorkbenchActionConstants.M_HELP);
    ...
    private void addExportModelExtensionMenuItems(IWorkbenchWindow window, IMenuManager exportMenu) {
        ...
        for(IConfigurationElement configurationElement : registry.getConfigurationElementsFor("org.rulez.magwas.zenta.editor.exportHandler")) { //$NON-NLS-1$
            try {
    ...
    private void addImportModelExtensionMenuItems(IWorkbenchWindow window, IMenuManager importMenu) {
        IExtensionRegistry registry = Platform.getExtensionRegistry();
        for(IConfigurationElement configurationElement : registry.getConfigurationElementsFor("org.rulez.magwas.zenta.editor.importHandler")) { //$NON-NLS-1$
            try {
                String id = configurationElement.getAttribute("id"); //$NON-NLS-1$
                String label = configurationElement.getAttribute("label"); //$NON-NLS-1$
