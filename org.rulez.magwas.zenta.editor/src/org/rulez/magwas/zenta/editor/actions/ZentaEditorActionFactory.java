 ...
 */
public final class ZentaEditorActionFactory {
    ...
    public static final ActionFactory DELETE = new ActionFactory("delete", //$NON-NLS-1$
        ...
        public IWorkbenchAction create(IWorkbenchWindow window) {
            ...
            LabelRetargetAction action = new LabelRetargetAction(getId(), Messages.ZentaEditorActionFactory_0);
            action.setToolTipText(Messages.ZentaEditorActionFactory_1);
    ...
    public static final ActionFactory RENAME = new ActionFactory("rename", //$NON-NLS-1$
        ...
        public IWorkbenchAction create(IWorkbenchWindow window) {
            ...
            LabelRetargetAction action = new LabelRetargetAction(getId(), Messages.ZentaEditorActionFactory_2);
            action.setToolTipText(Messages.ZentaEditorActionFactory_3);
            window.getPartService().addPartListener(action);
            action.setActionDefinitionId(getCommandId());
            return action;
        }
    ...
    public static final ActionFactory OPEN_DIAGRAM = new ActionFactory("open_diagram", //$NON-NLS-1$
        ...
        public IWorkbenchAction create(IWorkbenchWindow window) {
            ...
            RetargetAction action = new RetargetAction(getId(), Messages.ZentaEditorActionFactory_4);
            window.getPartService().addPartListener(action);
    ...
    public static final ActionFactory CLOSE_MODEL = new ActionFactory("close_model", //$NON-NLS-1$
        ...
        public IWorkbenchAction create(IWorkbenchWindow window) {
            ...
            RetargetAction action = new RetargetAction(getId(), Messages.ZentaEditorActionFactory_5);
            window.getPartService().addPartListener(action);
            // Don't do this unless registering a key binding in plugin.xml
            action.setActionDefinitionId(getCommandId());
            return action;
    ...
    public static final ActionFactory DUPLICATE = new ActionFactory("duplicate", //$NON-NLS-1$
        ...
        public IWorkbenchAction create(IWorkbenchWindow window) {
            ...
            LabelRetargetAction action = new LabelRetargetAction(getId(), Messages.ZentaEditorActionFactory_6);
            window.getPartService().addPartListener(action);
            // Don't do this unless registering a key binding in plugin.xml
            action.setActionDefinitionId(getCommandId());
            return action;
