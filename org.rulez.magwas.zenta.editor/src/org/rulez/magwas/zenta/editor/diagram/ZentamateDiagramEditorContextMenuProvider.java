 ...
 */
public class ZentamateDiagramEditorContextMenuProvider extends AbstractDiagramEditorContextMenuProvider {

    public static final String ID = "ZentamateDiagramEditorContextMenuProvider"; //$NON-NLS-1$
     ...
     */
    public ZentamateDiagramEditorContextMenuProvider(EditPartViewer viewer, ActionRegistry registry) {
    ...
    public void buildContextMenu(IMenuManager menu) {
        ...
        IMenuManager viewPointMenu = new MenuManager(Messages.ZentamateDiagramEditorContextMenuProvider_0);
        ...
        IMenuManager derivedRelationsMenu = new MenuManager(Messages.ZentamateDiagramEditorContextMenuProvider_1);
