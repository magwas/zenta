 ...
 */
public class CompositionConnectionFigure extends AbstractZentaConnectionFigure {
    ...
    public CompositionConnectionFigure(IDiagramModelZentaConnection connection) {
        super(connection);
    }
