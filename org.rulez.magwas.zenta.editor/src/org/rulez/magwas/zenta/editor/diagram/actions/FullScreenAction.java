...
public class FullScreenAction extends WorkbenchPartAction {
    ...
    public static final String ID = "org.rulez.magwas.zenta.editor.action.fullScreen"; //$NON-NLS-1$
    ...
    public void run() {
        ...
        fNewShell.setImage(IZentaUIImages.ImageFactory.getImage(IZentaImages.ICON_APP_128));
