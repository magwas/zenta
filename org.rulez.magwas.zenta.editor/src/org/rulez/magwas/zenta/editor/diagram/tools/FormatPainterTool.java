...
import org.rulez.magwas.zenta.editor.diagram.commands.BorderColorCommand;
...
import org.rulez.magwas.zenta.editor.diagram.commands.FontColorCommand;
...
public class FormatPainterTool extends AbstractTool {
    ...
    protected boolean isPaintableObject(Object object) {
        ...
        if(object instanceof IDiagramModelZentaObject) {
            IZentaElement element = ((IDiagramModelZentaObject)object).getZentaElement();
