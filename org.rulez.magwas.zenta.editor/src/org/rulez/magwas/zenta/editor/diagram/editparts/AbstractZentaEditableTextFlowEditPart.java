...
import org.rulez.magwas.zenta.editor.diagram.policies.ZentaContainerEditPolicy;
import org.rulez.magwas.zenta.editor.diagram.policies.ZentaContainerLayoutPolicy;
 ...
 */
public abstract class AbstractZentaEditableTextFlowEditPart
extends AbstractZentaEditPart implements IColoredEditPart, ITextAlignedEditPart {
    ...
    protected void createEditPolicies() {
        ...
        installEditPolicy(EditPolicy.LAYOUT_ROLE, new ZentaContainerLayoutPolicy());
        
        // Orphaning
        installEditPolicy(EditPolicy.CONTAINER_ROLE, new ZentaContainerEditPolicy());
