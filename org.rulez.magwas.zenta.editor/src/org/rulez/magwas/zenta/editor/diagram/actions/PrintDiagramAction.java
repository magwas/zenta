...
public class PrintDiagramAction extends WorkbenchPartAction {
    ...
    protected boolean calculateEnabled() {
        /*
         * On Linux we get the dreaded "Prevented recursive attempt to activate part org.rulez.magwas.zenta.editor.treeModelView
         * while still in the middle of activating part org.rulez.magwas.zenta.editor.diagramEditor" if we open a diagram editor
