...
/**
 * Zentamate Diagram Native DnD listener
 * 
 * @author Phillip Beauvoir
 */
public class ZentamateDiagramTransferDropTargetListener extends AbstractDiagramTransferDropTargetListener {
    
    public static final String ADD_ELEMENT_CONNECTIONS = "add_element_connections"; //$NON-NLS-1$

    public ZentamateDiagramTransferDropTargetListener(EditPartViewer viewer) {
        super(viewer);
    }
