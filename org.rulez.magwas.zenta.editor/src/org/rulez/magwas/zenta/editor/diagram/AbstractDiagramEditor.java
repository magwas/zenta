...
import org.rulez.magwas.zenta.editor.diagram.actions.ConnectionLineColorAction;
import org.rulez.magwas.zenta.editor.diagram.actions.ConnectionLineWidthAction;
import org.rulez.magwas.zenta.editor.diagram.actions.ConnectionRouterAction;
import org.rulez.magwas.zenta.editor.diagram.actions.CopyAction;
import org.rulez.magwas.zenta.editor.diagram.actions.CutAction;
import org.rulez.magwas.zenta.editor.diagram.actions.DefaultEditPartSizeAction;
import org.rulez.magwas.zenta.editor.diagram.actions.ExportAsImageAction;
import org.rulez.magwas.zenta.editor.diagram.actions.ExportAsImageToClipboardAction;
import org.rulez.magwas.zenta.editor.diagram.actions.FillColorAction;
import org.rulez.magwas.zenta.editor.diagram.actions.FontAction;
import org.rulez.magwas.zenta.editor.diagram.actions.FontColorAction;
import org.rulez.magwas.zenta.editor.diagram.actions.FullScreenAction;
import org.rulez.magwas.zenta.editor.diagram.actions.LockObjectAction;
import org.rulez.magwas.zenta.editor.diagram.actions.PasteAction;
import org.rulez.magwas.zenta.editor.diagram.actions.PrintDiagramAction;
import org.rulez.magwas.zenta.editor.diagram.actions.PropertiesAction;
import org.rulez.magwas.zenta.editor.diagram.actions.ResetAspectRatioAction;
import org.rulez.magwas.zenta.editor.diagram.actions.SelectAllAction;
import org.rulez.magwas.zenta.editor.diagram.actions.SelectElementInTreeAction;
import org.rulez.magwas.zenta.editor.diagram.actions.SendBackwardAction;
...
import org.rulez.magwas.zenta.editor.diagram.actions.ToggleGridEnabledAction;
import org.rulez.magwas.zenta.editor.diagram.actions.ToggleGridVisibleAction;
import org.rulez.magwas.zenta.editor.diagram.actions.ToggleSnapToAlignmentGuidesAction;
import org.rulez.magwas.zenta.editor.diagram.dnd.PaletteTemplateTransferDropTargetListener;
import org.rulez.magwas.zenta.editor.diagram.tools.FormatPainterInfo;
...
implements IDiagramModelEditor, IContextProvider, ITabbedPropertySheetPageContributor {
    ...
    public void dispose() {
        ...
        IDiagramModel model = getModel();
        if (null == model)
        	throw new IllegalArgumentException();
		IZentaModel zentaModel = model.getZentaModel();
        if(null == zentaModel)
        	throw new IllegalArgumentException();
		zentaModel.eAdapters().remove(eCoreAdapter);
    }
}
