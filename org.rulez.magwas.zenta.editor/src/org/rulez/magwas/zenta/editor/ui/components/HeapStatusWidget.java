package org.rulez.magwas.zenta.editor.ui.components;
...
public class HeapStatusWidget extends Composite {
	...
	public HeapStatusWidget(Composite parent) {
		...
		ImageDescriptor imageDesc = IZentamateImages.ImageFactory.getImageDescriptor(IZentamateImages.ICON_TRASH_16);
