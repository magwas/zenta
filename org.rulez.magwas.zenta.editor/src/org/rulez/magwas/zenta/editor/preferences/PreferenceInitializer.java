...
implements IPreferenceConstants {
    ...
    public void initializeDefaultPreferences() {
		IPreferenceStore store = ZentaEditorPlugin.INSTANCE.getPreferenceStore();
        
		store.setDefault(USER_DATA_FOLDER, ZentaEditorPlugin.INSTANCE.getWorkspaceFolder().getPath());
