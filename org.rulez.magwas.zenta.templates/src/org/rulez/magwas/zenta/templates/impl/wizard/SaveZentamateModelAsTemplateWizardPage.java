...
/**
 * Save Zentamate Model As Template Wizard Page
 * 
 * @author Phillip Beauvoir
 */
public class SaveZentamateModelAsTemplateWizardPage extends WizardPage {

    private static String HELP_ID = "org.rulez.magwas.zenta.help.SaveZentamateModelAsTemplateWizardPage"; //$NON-NLS-1$
    ...
    public SaveZentamateModelAsTemplateWizardPage(IZentamateModel model, TemplateManager templateManager) {
        super("SaveModelAsTemplateWizardPage"); //$NON-NLS-1$
        setTitle(Messages.SaveZentamateModelAsTemplateWizardPage_2);
        setDescription(Messages.SaveZentamateModelAsTemplateWizardPage_3);
    ...
    public void createControl(Composite parent) {
        ...
        label.setText(Messages.SaveZentamateModelAsTemplateWizardPage_4);
        ...
        File newFile = new File(CURRENT_FOLDER, Messages.SaveZentamateModelAsTemplateWizardPage_5 + ZentamateTemplateManager.ARCHIMATE_TEMPLATE_FILE_EXTENSION);
        ...
        fileButton.setText(Messages.SaveZentamateModelAsTemplateWizardPage_6);
        ...
        label.setText(Messages.SaveZentamateModelAsTemplateWizardPage_7);
        ...
        label = new Label(fieldGroup, SWT.NULL);
        label.setText(Messages.SaveZentamateModelAsTemplateWizardPage_8);
        ...
        fButtonIncludeThumbs.setText(Messages.SaveZentamateModelAsTemplateWizardPage_9);
        ...
        label.setText(Messages.SaveZentamateModelAsTemplateWizardPage_10);
    ...
    private File chooseFile() {
        ...
        dialog.setText(Messages.SaveZentamateModelAsTemplateWizardPage_11);
        dialog.setFilterExtensions(new String[] { "*" + fTemplateManager.getTemplateFileExtension(), "*.*" } ); //$NON-NLS-1$ //$NON-NLS-2$
        String path = dialog.open();
        if(path != null) {
            // Only Windows adds the extension by default
            if(dialog.getFilterIndex() == 0 && !path.endsWith(ZentamateTemplateManager.ARCHIMATE_TEMPLATE_FILE_EXTENSION)) {
                path += ZentamateTemplateManager.ARCHIMATE_TEMPLATE_FILE_EXTENSION;
            }
    ...
    private void validateFields() {
        ...
        if(!StringUtils.isSetAfterTrim(fileName)) {
            updateStatus(Messages.SaveZentamateModelAsTemplateWizardPage_14);
            return;
        }
        
        String name = getTemplateName();
        if(!StringUtils.isSetAfterTrim(name)) {
            updateStatus(Messages.SaveZentamateModelAsTemplateWizardPage_15);
            return;
        }
