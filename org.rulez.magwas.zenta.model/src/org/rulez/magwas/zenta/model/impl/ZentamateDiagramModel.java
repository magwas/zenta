 ...
 * <ul>
 *   <li>{@link org.rulez.magwas.zenta.model.impl.ZentamateDiagramModel#getViewpoint <em>Viewpoint</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ZentamateDiagramModel extends DiagramModel implements IZentamateDiagramModel {
    /**
	 ...
	 * @generated
	 */
    protected ZentamateDiagramModel() {
		super();
	}
    ...
    protected EClass eStaticClass() {
		return IZentamatePackage.Literals.ARCHIMATE_DIAGRAM_MODEL;
	}
    ...
    public void setViewpoint(int newViewpoint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IZentamatePackage.ARCHIMATE_DIAGRAM_MODEL__VIEWPOINT, oldViewpoint, viewpoint));
	}
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IZentamatePackage.ARCHIMATE_DIAGRAM_MODEL__VIEWPOINT:
				return getViewpoint();
		}
