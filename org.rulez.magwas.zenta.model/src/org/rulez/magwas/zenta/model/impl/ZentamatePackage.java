 ...
 * @generated
 */
public class ZentamatePackage extends EPackageImpl implements IZentamatePackage {
    /**
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
    private EClass diagramModelZentamateObjectEClass = null;
	 ...
	 * @generated
	 */
    private EClass diagramModelZentamateConnectionEClass = null;
	 ...
	 * @see org.rulez.magwas.zenta.model.IZentamatePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
    private ZentamatePackage() {
		super(eNS_URI, IZentamateFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link IZentamatePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
    public static IZentamatePackage init() {
		if (isInited) return (IZentamatePackage)EPackage.Registry.INSTANCE.getEPackage(IZentamatePackage.eNS_URI);

		// Obtain or create and register package
		ZentamatePackage theZentamatePackage = (ZentamatePackage)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ZentamatePackage ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ZentamatePackage());

		isInited = true;

		// Create package meta-data objects
		theZentamatePackage.createPackageContents();

		// Initialize created meta-data
		theZentamatePackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theZentamatePackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(IZentamatePackage.eNS_URI, theZentamatePackage);
		return theZentamatePackage;
	}
	 ...
	 * @generated
	 */
    public EClass getDiagramModelZentamateObject() {
		return diagramModelZentamateObjectEClass;
	}
	 ...
	 * @generated
	 */
    public EReference getDiagramModelZentamateObject_ZentamateElement() {
		return (EReference)diagramModelZentamateObjectEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
    public EAttribute getDiagramModelZentamateObject_Type() {
		return (EAttribute)diagramModelZentamateObjectEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
    public EClass getDiagramModelZentamateConnection() {
		return diagramModelZentamateConnectionEClass;
	}
	 ...
	 * @generated
	 */
    public EReference getDiagramModelZentamateConnection_Relationship() {
		return (EReference)diagramModelZentamateConnectionEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
    public IZentamateFactory getZentamateFactory() {
		return (IZentamateFactory)getEFactoryInstance();
	}
    ...
    public void createPackageContents() {
		...
		createEAttribute(diagramModelZentamateObjectEClass, DIAGRAM_MODEL_ARCHIMATE_OBJECT__TYPE);

		diagramModelZentamateConnectionEClass = createEClass(DIAGRAM_MODEL_ARCHIMATE_CONNECTION);
		createEReference(diagramModelZentamateConnectionEClass, DIAGRAM_MODEL_ARCHIMATE_CONNECTION__RELATIONSHIP);
    ...
    public void initializePackageContents() {
		...
		relationshipEClass.getESuperTypes().add(this.getZentamateElement());
		...
		businessLayerElementEClass.getESuperTypes().add(this.getZentamateElement());
		...
		diagramModelEClass.getESuperTypes().add(this.getZentamateModelElement());
		...
		initEReference(getRelationship_Source(), this.getZentamateElement(), null, "source", null, 0, 1, IRelationship.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEReference(getRelationship_Target(), this.getZentamateElement(), null, "target", null, 0, 1, IRelationship.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		addEOperation(diagramModelZentamateObjectEClass, null, "removeZentamateElementFromModel", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		initEClass(diagramModelZentamateConnectionEClass, IDiagramModelZentamateConnection.class, "DiagramModelZentamateConnection", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEReference(getDiagramModelZentamateConnection_Relationship(), this.getRelationship(), null, "relationship", null, 0, 1, IDiagramModelZentamateConnection.class, !IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$

		op = addEOperation(diagramModelZentamateConnectionEClass, null, "addRelationshipToModel", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, this.getFolder(), "parent", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		addEOperation(diagramModelZentamateConnectionEClass, null, "removeRelationshipFromModel", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
    ...
    protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation
		  (diagramModelZentamateObjectEClass, 
		   source, 
		   new String[] {
			 "name", "DiagramObject" //$NON-NLS-1$ //$NON-NLS-2$
		   });		
		addAnnotation
		  (diagramModelZentamateConnectionEClass, 
		   source, 
		   new String[] {
