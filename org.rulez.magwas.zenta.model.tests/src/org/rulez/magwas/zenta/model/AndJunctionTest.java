...
public class AndJunctionTest {

	@Rule
	public final ExpectedException exception = ExpectedException.none();

	IAndJunction uncheckedElement;
	IAndJunction element;
	...
	public void setUp() throws Exception {
		...
		model.check();
		element=IZentaFactory.eINSTANCE.createAndJunction();
		element.check();
		uncheckedElement=IZentaFactory.eINSTANCE.createAndJunction();
	}
