 ...
 * <ul>
 *   <li>{@link org.rulez.magwas.zenta.canvas.model.impl.CanvasModelImage#isLocked <em>Locked</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == ILockable.class) {
            switch (derivedFeatureID) {
                case ICanvasPackage.CANVAS_MODEL_IMAGE__LOCKED: return IZentaPackage.LOCKABLE__LOCKED;
                default: return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == ILockable.class) {
            switch (baseFeatureID) {
                case IZentaPackage.LOCKABLE__LOCKED: return ICanvasPackage.CANVAS_MODEL_IMAGE__LOCKED;
                default: return -1;
            }
        }
